...
void borderLines()
  {
    ...
    for( size_t i = 0; i < lines.size(); i++ )
    {
     ...
     cout<<" rho = "<<rho<<" theta = "<<(180.0*theta)/CV_PI<<endl;
     Point pt1, pt2;
     double a = cos(theta), b = sin(theta);
     double x0 = a*rho, y0 = b*rho;
     pt1.x = cvRound(x0 + 1000000*(-b));
     pt1.y = cvRound(y0 + 1000000*(a));
     pt2.x = cvRound(x0 - 1000000*(-b));
     pt2.y = cvRound(y0 - 1000000*(a));
     
     line( img2, pt1, pt2, Scalar(255,0,0), 2,8);
